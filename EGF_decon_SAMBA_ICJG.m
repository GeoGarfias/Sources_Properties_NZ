...
for j=list_event; 
    cd /Users/home/juarezilma/Master/NETWORKS/SAMBA/EGF_matlab/WORK % set to work directory
    load cluster_SAMBA.mat
                                                    ...
                                                    if noi_startj < length(sgmj.data) && noi_startj+ nj > 5                                                       
                                                        ...
                                                        if clip == 0    
                                                            ...
                                                            if noi_startl < length(sgml.data) && noi_startl+ nl > 5
                                                                ...
                                                                output_name = ['SAMBA_' nsgmj(18:end) '_' nsgmj(3:16)  ];
                                                                output_namel= nsgml(3:16);
                                                                output_namell = ['SAMBA_'  nsgml(18:end) '_' nsgml(3:16)];
                                                                ...
                                                                if (max(xcoraf3) >= xcor_limit) && (max(xcoraf3) < 0.99) 
                                                                    ...
                                                                    if sum(sum(isnan(tfun))) == 0                                                                  
                                                                        ...
                                                                        eval([output_name '_' output_namel '_' PS_letter(PS) '.ml = [sgmj.mag sgml.mag];']);
                                                                        % elat,elon= event
                                                                        ...
                                                                        title1d=['Spectral Ratio: ML' num2str(cluster.mag(1)) ' / ' num2str(cluster.mag(l)) ];
                                                                        title(title1d,'FontSize', 7);ylabel('Amplitude Ratio'); %: German .m code');
